export const zx7 = {
  ...
  features: `Reap the advantages of a flat diaphragm tweeter cone. This provides a fast response
   ...
   The woofers are made from aluminum that produces a unique and clear sound. XLR inputs allow
   you to connect to a mixer for more advanced usage.`,
  feature2: `The ZX7 speaker is the perfect blend of stylish design and high performance.
